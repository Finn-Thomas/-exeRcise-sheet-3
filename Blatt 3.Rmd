...
Die relative Änderung liegt in tabellarischer Form vor. Wird sich im folgenden Text darauf bezogen, dann steht das in Einklang mit den Werten der Tabelle. Weiterhin sind die Werte geschätzt, da es in einigen Fällen keine eindeutige Quelle aller Malariafälle gibt. Deshalb werden zur Schätzung komplexere Modelle und verschiedene Quellen verwendet, die Anzahl ist also nie exakt, sollte aber nahe an den tatsächlichen Todesfällen dran sein.
