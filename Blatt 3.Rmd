...
**Frage: Hat die Anzahl an Malariatoten in zentralafrikanischen Ländern im Laufe der Jahre (absolut) abgenommen?**
...
```{r}
data_malaria_mid_afr_vgl <- data_malaria_mid_afr %>%
